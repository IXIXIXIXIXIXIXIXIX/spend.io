...
colour_repository.save(colour2)
...
transaction3 = Transaction(gamestop, 3.00, "2121-01-29")
transaction4 = Transaction(gamestop, 3.00, "2121-01-15")
transaction5 = Transaction(lidl, 3.00, "2121-01-15")
transaction6 = Transaction(gamestop, 3.00, "2121-01-15")
transaction7 = Transaction(gamestop, 10.00, "2121-01-15")
transaction8 = Transaction(merchant1, 3.00, "2121-01-15")
transaction9 = Transaction(bp, 40.00, "2121-01-15")
transaction10 = Transaction(gamestop, 3.00, "2121-01-15")
transaction11 = Transaction(amazon, 3.00, "2121-01-15")
transaction12 = Transaction(bp, 3.00, "2121-01-15")
transaction13 = Transaction(lidl, 3.00, "2121-01-15")
transaction14 = Transaction(lidl, 3.00, "2121-01-15")
